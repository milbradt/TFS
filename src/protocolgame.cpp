...
void ProtocolGame::parsePacket(NetworkMessage &msg)
{
	...
	if(m_spectator)
	{
		switch(recvbyte)
		{
			case 0x14: // allow to logout
				parseLogout(msg);
				break;

			case 0x96: // allow to talk in spectator chat
				parseSay(msg);
				break;

			case 0x97: // allow opening spectator chat
				parseGetChannels(msg);
				break;

			case 0x98: // allow opening spectator chat
				parseOpenChannel(msg);
				break;

			case 0xC9: // allow to request update tile
				parseUpdateTile(msg);
				break;

			case 0xCA: // allow to request update container
				parseUpdateContainer(msg);
				break;

			case 0xE8: // allow debug asserts
				parseDebugAssert(msg);
				break;

			default: // ignore other actions silently
				sendCancelWalk();
				break;
		}
	}
