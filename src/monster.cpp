...
Monster* Monster::createMonster(MonsterType* mType, std::string customName /* = ""*/)
{
	return new Monster(mType, customName);
}
...
Monster::Monster(MonsterType* _mType, std::string customName /* = ""*/):
	Creature()
{
	cName = customName;
	isIdle = true;
