...
{
	private:
		Monster(MonsterType* _mType, std::string customName = (std::string)"");
	...
	public:
		...
		static Monster* createMonster(MonsterType* mType, std::string customName = (std::string)"");
		static Monster* createMonster(const std::string& name, std::string customName = (std::string)"");
		...
		virtual const std::string& getName() const {return (cName != "" ? cName : mType->name);}
